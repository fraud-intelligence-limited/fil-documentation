...
FIB is a decentralized network that enables the secure sharing and analysis of data related to [*fraud events*](../Overview/Fraud_events.md).
...
The FIB network serves as a secure database of various [fraud events](./Fraud_events) that are stored on the blockchain as [*contributions*](./Contributions.md).
