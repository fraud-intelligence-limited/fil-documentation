...
For instructions on how to upload a fraud event—submit a contribution—see [Submitting a contribution](../tutorials-api/submitting-a-contribution.md).
...
For instructions on how to download a fraud event—retrieve a contribution—see [Retrieving top contributions](../tutorials-api/retrieving-top-contributions.md).
