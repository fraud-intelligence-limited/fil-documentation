...
If authorization is unseccessful, refer to *[Authorizing a user in the system/#responses](/API_Specification/auth-controller/Authorizing_a_user_in_the_system.md)* for a list of possible reasons.
